class Floor {
  static grassFloor(scene) {
    ...
    const mat = new THREE.MeshLambertMaterial({map:floorTexture, aoMap: floorTextureAo, bumpMap: floorTextureHeight, normalMap: floorTextureNormal, roughnessMap:floorTextureRoughness });
